...
if __name__ == '__main__':
	data = AlpacaData(start=datetime.datetime(2011,11,1), end=datetime.datetime(2021,4,1), timeframe='day', symbols=["SPY"], live=False)
	manager = Manager(data)
	algo = MACDstrategy()
	manager.add_algo(algo)
	manager.backtest(start=datetime.datetime(2012,1,1), end=datetime.datetime(2021,4,1))